...
SECRET_KEY = 'django-insecure-7ucq4p0aqbbepvv-7sgu9bjmxp$usxm&6&4bevu6^#_helpxi-'
...
DEFAULT_FROM_EMAIL = 'noreply@supplychain.com'

# Frontend URL for email links
FRONTEND_URL = 'http://localhost:3000'  # Adjust based on your frontend
